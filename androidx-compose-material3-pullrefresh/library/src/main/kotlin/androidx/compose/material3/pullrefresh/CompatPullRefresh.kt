 ...
 *
 * @param state The [CompatPullRefreshState] associated with this pull-to-refresh component.
...
fun Modifier.pullRefresh(
    ...
    Modifier.nestedScroll(CompatPullRefreshNestedScrollConnection(onPull, onRelease, enabled))
}

private class CompatPullRefreshNestedScrollConnection(
