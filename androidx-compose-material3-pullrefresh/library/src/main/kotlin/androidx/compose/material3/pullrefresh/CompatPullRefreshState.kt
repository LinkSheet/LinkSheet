...
/**
 * Creates a [CompatPullRefreshState] that is remembered across compositions.
 *
 * Changes to [refreshing] will result in [CompatPullRefreshState] being updated.
 *
...
fun rememberPullRefreshState(
    refreshing: Boolean,
    onRefresh: () -> Unit,
    refreshThreshold: Dp = CompatPullRefreshDefaults.RefreshThreshold,
    refreshingOffset: Dp = CompatPullRefreshDefaults.RefreshingOffset,
): CompatPullRefreshState {
    ...
    val state = remember(scope) {
        CompatPullRefreshState(scope, onRefreshState, refreshingOffsetPx, thresholdPx)
    }
 ...
 */
class CompatPullRefreshState internal constructor(
 ...
 */
object CompatPullRefreshDefaults {
    /**
