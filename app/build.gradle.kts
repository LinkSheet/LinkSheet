...
dependencies {
    ...
    implementation("com.gitlab.grrfe:GSONKtExtensions:3.1.0")
    implementation("com.gitlab.grrfe:kotlin-ext:0.0.8")
    ...
    implementation("com.github.1fexd:cached-urls:0.0.3")
