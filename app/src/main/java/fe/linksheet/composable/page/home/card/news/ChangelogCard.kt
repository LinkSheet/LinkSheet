...
@Composable
fun ChangelogCard(
    @StringRes titleId: Int = R.string.settings_main_changelog__title_changelog,
    icon: IconPainter = Icons.Outlined.AutoAwesome.iconPainter,
    @StringRes contentId: Int = R.string.settings_main_changelog__text_changelog,
    ...
    AlertCard(
        ...
        subtitle = textContent(contentId, version)
    ) {
