...
fun LargeTopAppBar(
    ...
    TwoRowsTopAppBar(
        ...
        smallTitleTextStyle = TitleLarge,
...
@Composable
internal fun TopAppBarColors.containerColor(
    containerColor: Color = MaterialTheme.colorScheme.surface,
...
private fun TwoRowsTopAppBar(
    ...
    val actionsRow = @Composable {
        Row(
            horizontalArrangement = if(titleHorizontalArrangement == Arrangement.Start) Arrangement.End else Arrangement.Start,
