...
sealed class ResolveModule(val key: String, @StringRes val shortNameStringResId: Int, @StringRes val stringResId: Int) : StringResHolder {
    ...
    override fun stringResId() = shortNameStringResId
}
