        ...
        return object : ILinkSheetService.Stub() {
            override fun getSelectedDomains(packageName: String): StringParceledListSlice {
                ...
                return runBlocking(Dispatchers.IO) {
                    try {
                        this@InterconnectService2.getSelectedDomains(packageName)
                    } catch (e: Exception) {
                        cancel(e.message!!, e)
                        throw e
                    }
            ...
            override fun getSelectedDomainsAsync(packageName: String, callback: ISelectedDomainsCallback) {
                ...
                launch(Dispatchers.IO) {
                    callback.onSelectedDomainsRetrieved(this@InterconnectService2.getSelectedDomains(packageName))
                }
            }
            ...
            override fun selectDomains(
                ...
                SelectDomainsConfirmationActivity.Companion.start(
                    this@InterconnectService2, packageName, componentName, domains,
                )
            }
