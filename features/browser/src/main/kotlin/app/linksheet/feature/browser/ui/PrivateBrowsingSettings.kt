...
private fun PrivateBrowsingSettingsRouteInternal(
    ...
    SaneScaffoldSettingsPage(
        ...
        item(key = R.string.settings_private_browsing__title_enable, contentType = ContentType.SingleGroupItem) {
            SwitchListItem(
                checked = enabled,
                onCheckedChange = onEnable,
                position = ContentPosition.Trailing,
                headlineContent = textContent(R.string.settings_private_browsing__title_enable),
