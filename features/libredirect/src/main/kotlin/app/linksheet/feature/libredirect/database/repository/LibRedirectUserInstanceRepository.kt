...
class LibRedirectUserInstanceRepository(private val dao: LibRedirectUserInstanceDao) {
    fun getByServiceAndFrontendOrNull(serviceKey: String, frontend: FrontendState): Flow<List<LibRedirectUserInstance>> {
        return dao.getByServiceAndFrontendOrNull(serviceKey, frontend.frontendKey)
    }
