...
import fe.androidx.compose.material3.internal.ProvideContentColorTextStyle
import fe.androidx.compose.material3.internal.systemBarsForVisualComponents
import fe.androidx.compose.material3.tokens.BottomAppBarTokens
import fe.androidx.compose.material3.tokens.FabSecondaryContainerTokens
import fe.androidx.compose.material3.tokens.MotionSchemeKeyTokens
import fe.androidx.compose.material3.tokens.TopAppBarLargeTokens
import fe.androidx.compose.material3.tokens.TopAppBarMediumTokens
import fe.androidx.compose.material3.tokens.TopAppBarSmallCenteredTokens
import fe.androidx.compose.material3.tokens.TopAppBarSmallTokens
 ...
 *   typically be an [androidx.compose.material3.IconButton] or [androidx.compose.material3.IconToggleButton].
 * @param actions the actions displayed at the end of the top app bar. This should typically be
 *   [androidx.compose.material3.IconButton]s. The default layout here is a [Row], so icons inside will be placed horizontally.
 ...
 *
 * It can optionally display a [androidx.compose.material3.FloatingActionButton] embedded at the end of the BottomAppBar.
 *
 * @sample androidx.compose.material3.samples.BottomAppBarWithFAB
 *
 * Also see [androidx.compose.material3.NavigationBar].
 *
 ...
 * image](https://developer.android.com/images/reference/androidx/compose/material3/bottom-app-bar.png)
 *
 * If you are interested in displaying a [androidx.compose.material3.FloatingActionButton], consider using another overload.
 *
 * Also see [androidx.compose.material3.NavigationBar].
 *
 * @param modifier the [Modifier] to be applied to this BottomAppBar
 ...
 *
 * If you are interested in displaying a [androidx.compose.material3.FloatingActionButton], consider using another overload
 * that takes a [androidx.compose.material3.FloatingActionButton] parameter.
 *
 * Also see [androidx.compose.material3.NavigationBar].
 *
...
object BottomAppBarDefaults {
     ...
     * [androidx.compose.material3.IconButton] that meet the minimum touch target (48.dp).
     */
    val ContentPadding =
        PaddingValues(
    ...
    /** The color of a [BottomAppBar]'s [androidx.compose.material3.FloatingActionButton] */
 ...
 *   [androidx.compose.material3.LocalContentColor] when composing the navigation icon
 * @param titleContentColor the color that will be applied via a [androidx.compose.material3.LocalContentColor] when composing
 *   the title
 * @param actionIconContentColor the content color that will be applied via a [androidx.compose.material3.LocalContentColor]
