...
package fe.androidx.compose.material3.tokens
...
internal object FilledTextFieldTokens {
    ...
    val ErrorHoverActiveIndicatorColor = ColorSchemeKeyTokens.OnErrorContainer
    ...
    val HoverActiveIndicatorColor = ColorSchemeKeyTokens.OnSurface
