...
import fe.androidx.compose.material3.SearchBarDefaults.InputFieldHeight
import fe.androidx.compose.material3.internal.BackEventCompat
import fe.androidx.compose.material3.internal.BackHandler
import fe.androidx.compose.material3.internal.MutableWindowInsets
import fe.androidx.compose.material3.internal.PredictiveBackHandler
import fe.androidx.compose.material3.internal.textFieldBackground
import fe.androidx.compose.material3.tokens.ElevationTokens
import fe.androidx.compose.material3.tokens.FilledTextFieldTokens
import fe.androidx.compose.material3.tokens.MotionSchemeKeyTokens
import fe.androidx.compose.material3.tokens.MotionTokens
import fe.androidx.compose.material3.tokens.SearchBarTokens
import fe.androidx.compose.material3.tokens.SearchViewTokens
...
import fe.androidx.compose.material3.internal.PredictiveBack
import fe.material3.getString
 ...
 * @param tonalElevation when [SearchBarColors.containerColor] is [androidx.compose.material3.ColorScheme.surface], a
...
object SearchBarDefaults {
     ...
     * @param textStyle the style to be applied to the input text. Defaults to [androidx.compose.material3.LocalTextStyle].
    ...
    fun InputField(
        ...
        val searchSemantics = getString(MaterialR.string.m3c_search_bar_search)
        val suggestionsAvailableSemantics = getString(MaterialR.string.m3c_suggestions_available)
    ...
    fun InputField(
        ...
        val searchSemantics = getString(MaterialR.string.m3c_search_bar_search)
        val suggestionsAvailableSemantics = getString(MaterialR.string.m3c_search_bar_search)
...
@Composable
internal fun getWindowContainerHeight(): Dp =
